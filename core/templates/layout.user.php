...
?>
<!DOCTYPE html>
<!-- TEMPLATE: ./themes/arteetmarte/core/templates/layout.user.php -->
...
<head data-user="<?php p($_['user_uid']); ?>" data-user-displayname="<?php p($_['user_displayname']); ?>" data-requesttoken="<?php p($_['requesttoken']); ?>">
    ...
    <!--		<link rel="mask-icon" sizes="any" href="--><?php //print_unescaped(image_path($_['appid'], 'favicon-mask.svg')); ?><!--" color="#795548">-->
...
<body id="<?php p($_['bodyid']);?>" class="app-<?php p($_['appid']) ?>">
...
<header role="banner">
    <div id="header">
        <a
            href="<?php print_unescaped(link_to('', 'index.php')); ?>"
            id="owncloud"
            tabindex="1">
        ...
        <a
            href="#"
            class="header-appname-container
				menutoggle" tabindex="2">
        ...
        <div id="logo-claim" style="display:none;">
            <?php p($theme->getLogoClaim()); ?>
        </div>
                    ...
                    <div class="avatardiv<?php if ($_['userAvatarSet']) { print_unescaped(' avatardiv-shown'); } else { print_unescaped('" style="display: none'); } ?>">
                        <?php if ($_['userAvatarSet']): ?>
                            <img alt="" width="32" height="32"
                                 ...
                                 srcset="<?php p(\OC::$server->getURLGenerator()->linkToRoute('core.avatar.getAvatar', ['userId' => $_['user_uid'], 'size' => 64]));?> 2x,
							<?php p(\OC::$server->getURLGenerator()->linkToRoute('core.avatar.getAvatar', ['userId' => $_['user_uid'], 'size' => 128]));?> 4x">
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
                <span id="expandDisplayName">
...
<footer id="footer-wrapper" class="footer">
    <?php
//    $output =
//        '© 2016 <a href="' . $theme->getBaseUrl() . '" target="_blank\">'
//        . $theme->getEntity()
//        . '</a>'
//        . ' - '
//        . $theme->getName()
